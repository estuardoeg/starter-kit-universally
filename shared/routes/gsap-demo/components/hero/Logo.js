  ...
  render() {
    ...
    return (
      <div className={s.logo}>
        <svg ref={(el) => { this.logo = el; }} fill="none" stroke="transparent" strokeWidth="1" viewBox="0 0 1175 270" className={`${s.logo__svg}`}>
        ...
        <div className={s.logo__dot} ref={(el) => { this.dot = el; }}>
          <svg className={s.logo__dotInner} viewBox="0 0 70 70" ref={(el) => { this.dotInner = el; }}>
