  ...
  helmet: {
    ...
    meta: [
      ...
      */
      ...
      { name: 'msapplication-TileImage', content: `${directoryPath}/favicons/mstile-150x150.png` },
      { name: 'msapplication-square70x70logo', content: `${directoryPath}/favicons/mstile-70x70.png` },
      { name: 'msapplication-square150x150logo', content: `${directoryPath}/favicons/mstile-150x150.png` },
      { name: 'msapplication-wide310x150logo', content: `${directoryPath}/favicons/mstile-310x150.png` },
      { name: 'msapplication-square310x310logo', content: `${directoryPath}/favicons/mstile-310x310.png` },
      { name: 'theme-color', content: '#00E2AD' },
      { property: 'og:image', content: `${directoryPath}/favicons/android-chrome-192x192.png` },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:image', content: `${directoryPath}/favicons/android-chrome-192x192.png` },
    ...
    link: [
      { rel: 'apple-touch-icon-precomposed', sizes: '152x152', href: `${directoryPath}/favicons/apple-touch-icon-152x152.png` },
      { rel: 'apple-touch-icon-precomposed', sizes: '144x144', href: `${directoryPath}/favicons/apple-touch-icon-144x144.png` },
      { rel: 'apple-touch-icon-precomposed', sizes: '120x120', href: `${directoryPath}/favicons/apple-touch-icon-120x120.png` },
      { rel: 'apple-touch-icon-precomposed', sizes: '114x114', href: `${directoryPath}/favicons/apple-touch-icon-114x114.png` },
      { rel: 'apple-touch-icon-precomposed', sizes: '76x76', href: `${directoryPath}/favicons/apple-touch-icon-76x76.png` },
      { rel: 'apple-touch-icon-precomposed', sizes: '72x72', href: `${directoryPath}/favicons/apple-touch-icon-72x72.png` },
      { rel: 'apple-touch-icon-precomposed', sizes: '57x57', href: `${directoryPath}/favicons/apple-touch-icon-57x57.png` },
      { rel: 'apple-touch-icon-precomposed', sizes: '60x60', href: `${directoryPath}/favicons/apple-touch-icon-60x60.png` },
      { rel: 'apple-touch-icon', sizes: '180x180', href: `${directoryPath}/favicons/apple-touch-icon-180x180.png` },
      { rel: 'mask-icon', href: `${directoryPath}/favicons/safari-pinned-tab.svg`, color: '#00a9d9' },
      { rel: 'icon', type: 'image/png', href: `${directoryPath}/favicons/favicon-196x196.png`, sizes: '196x196' },
      { rel: 'icon', type: 'image/png', href: `${directoryPath}/favicons/favicon-128.png`, sizes: '128x128' },
      { rel: 'icon', type: 'image/png', href: `${directoryPath}/favicons/favicon-96x96.png`, sizes: '96x96' },
      { rel: 'icon', type: 'image/png', href: `${directoryPath}/favicons/favicon-32x32.png`, sizes: '32x32' },
      { rel: 'icon', sizes: '16x16 32x32', href: `${directoryPath}/favicon.ico` },
      { rel: 'manifest', href: `${directoryPath}/manifest.json` },
    ],
  },
